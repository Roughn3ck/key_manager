...
def build_gui_exe():
    ...
    print("Building Key Manager GUI v2 executable...")
    ...
    args = [
        str(project_dir / 'src' / 'gui_main_v2.py'),
        '--name=key_manager_gui_v2',
        '--onefile',
...
def copy_to_usb_deployment():
    ...
    exe_path = Path('dist') / 'key_manager_gui_v2.exe'
    ...
    if target_path.exists():
        backup_path = backups_dir / 'key_manager_gui_v1.exe'
...
echo ========================================
echo.
echo Starting Key Manager GUI v2...
echo.
key_manager_gui.exe
pause
"""
...
def main():
    ...
    print("=" * 60)
    print("Key Manager GUI v2 - Portable EXE Builder")
    print("=" * 60)
